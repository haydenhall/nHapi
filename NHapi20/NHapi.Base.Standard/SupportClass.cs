...
namespace NHapi.Base.Standard
{
	...
	public class SupportClass
	{
		...
		public class TransactionManager
		{
			...
			{
				public DbCommand CreateStatement(SqlConnection connection)
				{
				...
				public void RollBack(SqlConnection connection)
				{
					if (this[connection] != null && !((ConnectionProperties) this[connection]).AutoCommit)
					{
						ConnectionProperties Properties = ((ConnectionProperties) this[connection]);
				...
				public void SetAutoCommit(SqlConnection connection, bool boolean)
				{
					if (this[connection] != null)
					{
						ConnectionProperties Properties = ((ConnectionProperties) this[connection]);
				...
				public DbCommand PrepareStatement(SqlConnection connection, String sql)
				{
				...
				public DbCommand PrepareCall(SqlConnection connection, String sql)
				{
					DbCommand command = CreateStatement(connection);
					command.CommandText = sql;
					command.CommandTimeout = 0;
				...
				public void SetTransactionIsolation(SqlConnection connection, int level)
				{
				...
				public int GetTransactionIsolation(SqlConnection connection)
				{
					if (this[connection] != null)
					{
						ConnectionProperties Properties = ((ConnectionProperties) this[connection]);
				...
				public bool GetAutoCommit(SqlConnection connection)
				{
					if (this[connection] != null)
		...
		public class OleDBSchema
		{
			...
			public OleDBSchema(SqlConnection Connection)
			{
